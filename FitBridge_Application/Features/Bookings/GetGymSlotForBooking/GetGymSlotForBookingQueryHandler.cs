...
public class GetGymSlotForBookingQueryHandler(IUnitOfWork _unitOfWork, IMapper _mapper, IUserUtil _userUtil, IHttpContextAccessor _httpContextAccessor) : IRequestHandler<GetGymSlotForBookingQuery, PagingResultDto<GetPtGymSlotForBookingResponse>>
{
