...
public class PTGymSlotConfiguration : IEntityTypeConfiguration<PTGymSlot>
{
    public void Configure(EntityTypeBuilder<PTGymSlot> builder)
    {
        ...
        .HasConversion(convertToProviderExpression: s => s.ToString(), convertFromProviderExpression: s => Enum.Parse<PTGymSlotStatus>(s))
        .HasDefaultValue(PTGymSlotStatus.Activated);
